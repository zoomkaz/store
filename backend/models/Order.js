...
class Order {
  ...
  async create(data) {
    ...
    const { firstName, lastName, email, phone, address, deliweryWay, payOption, confirm, comment = null, userId = null } = data
    const order = await OrderMapping.create({
      firstName, lastName, email, phone, address, deliweryWay, payOption, confirm, comment, amount, userId
    })
