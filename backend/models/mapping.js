...
const Category = sequelize.define('category', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  name: { type: DataTypes.STRING, unique: true, allowNull: false },
  filters: { type: DataTypes.ARRAY(DataTypes.STRING), allowNull: false },
  image: { type: DataTypes.STRING, allowNull: false },
})
...
const Order = sequelize.define('order', {
  ...
  deliweryWay: { type: DataTypes.STRING, allowNull: false },
  payOption: { type: DataTypes.STRING, allowNull: false },
  confirm: { type: DataTypes.BOOLEAN, allowNull: false },
